...
// Create a dynamic theme for each existing theme name
const lightTheme: Theme = defaultTheme('light')
...
const providerFn = ({
  ...
  // HACK - workaround for react-theming messing up MUI theme object - https://github.com/react-theming/storybook-addon/issues/30#issuecomment-892844261
  const muiTheme = createTheme(JSON.parse(JSON.stringify(theme)))
  return (
